...
"""
ideas: we can use dfs 
    - In the main tree, we loop until see the subroot (subroot belongs to the subtree)
    - if we find it, compare if they are the same tree or not
