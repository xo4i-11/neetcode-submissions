        ...
        for i in range(len(nums)):
            ...
            while(l<r):
                ...
                if(total<0):
                    ...
                    #[-1,0,0,1,1] . prevent dup: [-1,0,1], [-1,0,1]
                    l+=1
                    r-=1
                    #we only need 1 while loop (remove 1 loop is find)
...
#looping through every elem
#in every elem, we gonna do 2 ptr for the other 2 elem
