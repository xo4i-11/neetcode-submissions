...
"""
#identify the first elem in the sequence by checking if it has right neighbor or not
#check if they have right neighbor or not

streak=0
unique_elem=set(nums)

for num in unique_elem:
    if num-1 in unique_elem:
        continue
    length=0
    while num+length in unique_elem:
        length+=1
...
#IDEAS:
#find the first elem of the streak
#find the next elem while traack the longest streak
