...
we gonna loop the right pointer
=> there will be 2 case:
1: the profit is less than the max profit => move left ptr to right ptr position 
2: the profit is bigger => the left ptr does not change
