...
#create each of them a hashmap such that the key will be the number of row, col or box;
#the value gonna be a set of every elem coordinate (the number)
...
def valid_sudoku(board):
    ...
    for r in range(9):
        for c in range(9):
            ...
            if boards[r][c] in rows[r] or boards[r][c] in cols[c] or boads[r][c] in squares[(r//3,c//3)]:
                return False
